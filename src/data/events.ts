...
export const EVENTS: GameEvent[] = [
  {
    ...
    effects: { incomeMultiplier: 2.0, resilienceMultiplier: 1.5, popCapMultiplier: 1.5, popGrowthMultiplier: 2.0 },
    unlocksBuildings: ['solar'],
  },
  {
    id: 'event_2', name: 'Clean Energy Kickstart', emoji: '⚡', color: '#3b82f6',
    cost: 3000, duration: 3,
    description: 'Launch wind farms citywide to slash fossil fuel dependence and usher in a clean energy future.',
    popupDescription: 'The turbines are spinning! Your city just took a giant leap toward energy independence — and the air already smells fresher. ⚡',
    conditions: { population: 200, renewablePct: 5 },
    effects: { incomeMultiplier: 2.0, pollutionMultiplier: 0.5, renewableMultiplier: 1.2, popCapMultiplier: 1.5 },
    unlocksBuildings: ['wind_turbine'],
  },
  {
  ...
  },
  {
    ...
    conditions: { population: 150000, resilience: 75 },
