...
export const EVENTS: GameEvent[] = [
  ...
  {
    id: 'event_5', name: 'Metro Transit Network', emoji: '🚇', color: '#ef4444',
    cost: 50000, duration: 4,
    description: 'Roll out a modern metro system with transit hubs connecting every neighborhood — goodbye traffic, hello clean air.',
    popupDescription: 'All aboard! The metro is running, trains are gliding silently through tunnels, and thousands of cars are off the road. Your city just got faster, cleaner, and way more connected. 🚇',
    conditions: { population: 5000, happiness: 40 },
    effects: { incomeMultiplier: 2.5, pollutionMultiplier: 0.5, popCapMultiplier: 2.5, popGrowthMultiplier: 3.0 },
    unlocksBuildings: ['transit_hub', 'metro_hub'],
  },
  {
  ...
  },
  {
    ...
    conditions: { population: 2000000, happiness: 70 },
    effects: { incomeMultiplier: 4.0, happinessMultiplier: 2.0, resilienceMultiplier: 2.0, renewableMultiplier: 2.0, pollutionMultiplier: 0.4, popCapMultiplier: 5.0, popGrowthMultiplier: 5.0 },
