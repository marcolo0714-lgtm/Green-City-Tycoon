...
export const BUILDINGS: Building[] = [
  ...
  { id: 'house', name: 'House', shortName: 'House', emoji: '🏠', cost: 20, category: 'economic',
    income: 10, pollution: 10, happinessBoost: 0.1, resilienceBoost: 0, renewableBoost: 0, height: 1, shape: 'house' },
  ...
  { id: 'park', name: 'Park', shortName: 'Park', emoji: '🌳', cost: 18, category: 'green',
    income: 0, pollution: -4, happinessBoost: 0.3, resilienceBoost: 0, renewableBoost: 0, height: 1, shape: 'park' },
  { id: 'green_roof', name: 'Green Roof', shortName: 'G. Roof', emoji: '🌿', cost: 40, category: 'green',
    income: 0, pollution: -2, happinessBoost: 0.1, resilienceBoost: 3, renewableBoost: 0, height: 1, shape: 'green_roof' },
  ...
  { id: 'wetland_restoration', name: 'Wetland Restoration', shortName: 'Wetland', emoji: '🪷', cost: 580, category: 'water',
    income: 15, pollution: -7, happinessBoost: 0.2, resilienceBoost: 1, renewableBoost: 0, height: 1, shape: 'wetland', unlockEvent: 'event_5' },

  // === EVENT 6: Green Architecture Expo ===
  { id: 'vertical_farm', name: 'Vertical Farm', shortName: 'V. Farm', emoji: '🌾', cost: 450, category: 'green',
    income: 16, pollution: -4, happinessBoost: 0.4, resilienceBoost: 0, renewableBoost: 0, height: 2, shape: 'stepped', unlockEvent: 'event_6' },
  { id: 'vertical_forest', name: 'Vertical Forest Tower', shortName: 'V. Forest', emoji: '🏗️', cost: 800, category: 'green',
    income: 24, pollution: -9, happinessBoost: 0.6, resilienceBoost: 0, renewableBoost: 0, height: 2, shape: 'forest_tower', unlockEvent: 'event_6' },

  // === EVENT 7: Water Renaissance ===
  { id: 'desalination', name: 'Desalination', shortName: 'Desal.', emoji: '🌊', cost: 650, category: 'water',
    income: 20, pollution: -4, happinessBoost: 0.2, resilienceBoost: 4, renewableBoost: 0, height: 2, shape: 'cylinder', unlockEvent: 'event_7' },
  ...
  { id: 'observatory', name: 'Observatory', shortName: 'Observ.', emoji: '🔭', cost: 800, category: 'science',
    income: 0, pollution: -2, happinessBoost: 0.3, resilienceBoost: 7, renewableBoost: 0, height: 2, shape: 'observatory', unlockEvent: 'event_8' },
  ...
  { id: 'factory', name: 'Factory', shortName: 'Factory', emoji: '🏭', cost: 1800, category: 'economic',
    income: 50, pollution: 15, happinessBoost: -0.2, resilienceBoost: 0, renewableBoost: 0, height: 1, shape: 'factory', unlockEvent: 'event_9' },
  ...
  { id: 'global_trade', name: 'Global Trade Hub', shortName: 'Trade Hub', emoji: '🌐', cost: 6000, category: 'economic',
    income: 110, pollution: 0, happinessBoost: 0.5, resilienceBoost: 4, renewableBoost: 0, height: 2, shape: 'trade_center', unlockEvent: 'event_9' },
  ...
  { id: 'world_peace', name: 'World Peace Garden', shortName: 'Peace Gdn', emoji: '☮️', cost: 12000, category: 'green',
    income: 0, pollution: -14, happinessBoost: 1.4, resilienceBoost: 0, renewableBoost: 0, height: 1, shape: 'peace_garden', unlockEvent: 'event_10' },
];
