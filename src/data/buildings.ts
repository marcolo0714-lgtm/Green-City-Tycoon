...
export const BUILDINGS: Building[] = [
  ...
  { id: 'ev_charging', name: 'EV Charging Hub', shortName: 'EV Hub', emoji: '🔌', cost: 50, category: 'transport',
    income: 0, pollution: -1, happinessBoost: 0, resilienceBoost: 0, renewableBoost: 2, height: 1, shape: 'charging_station' },
  ...
  { id: 'transit_hub', name: 'Transit Hub', shortName: 'Transit', emoji: '🚇', cost: 300, category: 'transport',
    income: 18, pollution: -3, happinessBoost: 0, resilienceBoost: 1, renewableBoost: 2, height: 2, shape: 'dome', unlockEvent: 'event_5' },
  { id: 'metro_hub', name: 'Metro Hub', shortName: 'Metro', emoji: '🚉', cost: 600, category: 'transport',
    income: 38, pollution: -4, happinessBoost: 0, resilienceBoost: 3, renewableBoost: 0, height: 2, shape: 'station', unlockEvent: 'event_5' },
